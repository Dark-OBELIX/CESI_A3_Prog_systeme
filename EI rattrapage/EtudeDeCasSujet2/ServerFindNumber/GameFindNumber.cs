...
class GameFindNumber
{
    ...
    public void Game(object clientObj)
    {
        ...
        string AdresseIPclient = ((IPEndPoint)clientSocket.RemoteEndPoint).Address.ToString();
        int PortIPClient = ((IPEndPoint)this.clientSocket.RemoteEndPoint).Port;

        Console.WriteLine("Adresse IP du client : " + AdresseIPclient);
        Console.WriteLine("Port du client : " + PortIPClient);
